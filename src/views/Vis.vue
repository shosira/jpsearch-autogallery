  ...
  <v-container>
    <div style="width : 100%; height : 600px">
      <l-map :zoom="zoom" :center="center">
        ...
        <l-marker v-for="(marker, index) in markers" :lat-lng="marker.latlng" v-bind:key="index">
          <l-popup>
...
export default {
  ...
  data() {
    return {
      zoom: 7,
      center: LMap.latLng(47.41322, -1.219482),
    ...
    axios
      ...
      .then(response => {
        ...
        for (let i = 0; i < this.results_event.length; i++) {
          ...
          let marker = {
            latlng: LMap.latLng(Number(obj.lat.value), Number(obj.long.value)),
